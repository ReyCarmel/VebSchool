...
import com.venture.vebschool.MenuActivities.StudentMarkDetails;
...
public class MarkDetailsAdapter extends RecyclerView.Adapter<MarkDetailsAdapter.MarkDetails>{
    ...
    public class MarkDetails extends RecyclerView.ViewHolder {
        ...
        public MarkDetails(@NonNull View itemView) {
            super(itemView);
            t_class=itemView.findViewById(R.id.mclass);
            t_email=itemView.findViewById(R.id.memail);
            t_name=itemView.findViewById(R.id.mname);
